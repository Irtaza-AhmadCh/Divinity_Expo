...
class _AdminmainState extends State<Adminmain> {
  ...
  final _firestoreRef = FirebaseFirestore.instance.collection('Booth');
  bool loader =false;
              ...
              children: [
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: (_image == null) ? Icon(Icons.add_a_photo,color: MyColors.white,size: 50,) :
                                Image.file(_image!),
                          ),
                        ),
                ...
                InkWell(
                    ...
                    onTap: () async {
                      ...
                      NavigateTo(context, SponsorList());
                    },
                    child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('Upload Data on Sponsor List',
                              style: TextStyle(
